...
+ (NSData *)createContentReceiptData:(StarIoExtEmulation)emulation
    ...
    [localizeReceipts appendContentReceiptData:builder content:content utf8:utf8];
...
+ (NSData *)createBitmapData:(StarIoExtEmulation)emulation
    ...
    [builder appendBitmap:bitmap diffusion:NO width:paperSize bothScale:YES rotation:SCBBitmapConverterRotationNormal];
